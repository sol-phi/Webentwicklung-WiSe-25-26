<body>
    ...
    <nav class="navbar navbar-expand bg-blue">
        ...
        <div class="container">
            ...
            <img src="<?= base_url('assets/img/WE-Logo.svg') ?>" alt="WE-Logo" class="text-white" height="50">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link text-white <?= ($segment === 'tasks' || $segment === '') ? 'active' : '' ?>"
                           href="<?= base_url('main-controller/tasks') ?>">Tasks</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white <?= $segment === 'boards' ? 'active' : '' ?>"
                           href="<?= base_url('main-controller/boards') ?>">Boards</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white <?= ($segment === 'spalten' || $segment === 'spalten-erstellen') ? 'active' : '' ?>"
                           href="<?= base_url('main-controller/spalten') ?>">Spalten</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white <?= $segment === 'personen' ? 'active' : '' ?>"
                           href="<?= base_url('main-controller/personen') ?>">Personen</a>
                    </li>
                </ul>
            </div>
        </div>
